...
(() => {
  ...
  if (isRealPath(modelData.heroImage)) {
    ...
    frame.innerHTML = `<img src="./${modelData.heroImage}" alt="${modelData.professionalName}" fetchpriority="high" style="width:100%;height:100%;object-fit:contain;object-position:center;position:absolute;inset:0;background:#151515;">`;
  }
