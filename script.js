...
(() => {
  ...
  $('#inquiry-form').addEventListener('submit', async event => {
    ...
    if (!name || !validEmail || !text) {
      message.className = 'form-message error';
      message.textContent = 'Please enter your name, a valid email address, and a message.';
      return;
    }
    ...
    try {
      const response = await fetch('https://formspree.io/f/xkjnvpdn', {
        method: 'POST',
      ...
      message.className = 'form-message error';
      message.textContent = 'Sorry, your inquiry could not be sent. Please try again.';
    } finally {
