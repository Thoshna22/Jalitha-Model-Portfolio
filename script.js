(() => {
  ...
  if (isRealPath(modelData.heroImage)) {
    ...
    frame.innerHTML = `<img src="${modelData.heroImage}" alt="${modelData.professionalName}" fetchpriority="high">`;
  }
  ...
  const contactRows = [
    ...
    ['Email', `<a href="mailto:${modelData.contact.email}">${modelData.contact.email}</a>`],
  ...
  footerContact.innerHTML = `<p>${modelData.contact.location}</p><p><a href="mailto:${modelData.contact.email}">${modelData.contact.email}</a></p><p><a href="tel:${modelData.contact.phoneHref}">${modelData.contact.phone}</a></p>`;
